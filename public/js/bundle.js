    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          console.error('Error during login:', _context.t0.response ? _context.t0.response.data : _context.t0.message);
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.patch('/api/v1/users/update-MyProfile', form);
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
...
var updatePass = exports.updatePass = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(currPass, newPass) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _axios.default.patch('/api/v1/users/update-password', {
        ...
        case 7:
          ...
          console.log(_context2.t0.response.data); // This will show you the actual error message from the server
        case 11:
        case "end":
          return _context2.stop();
      }
  ...
  return function updatePass(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();
...
var passChange = document.querySelector('.form-user-password');
// console.log(2+3);
...
if (UserData) {
  UserData.addEventListener('submit', function (e) {
    ...
    (0, _updateSetting.updateData)(form);
  });
}
if (passChange) {
  passChange.addEventListener('submit', function (e) {
    e.preventDefault();
    var saveButton = document.querySelector('.btn--save-password');
    saveButton.textContent = 'Updating...';
    var currPass = document.getElementById('password-current').value;
    var newPass = document.getElementById('password').value;
    var conNewPass = document.getElementById('password-confirm').value;
    if (newPass === conNewPass) {
      (0, _updateSetting.updatePass)(currPass, newPass).then(function () {
